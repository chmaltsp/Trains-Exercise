...
csvImport.directive('ngCsvImport', function() {
	return {
		...
		template: 
//        '<div><div ng-show="header && headerVisible"><div class="label">Header</div><input type="checkbox" ng-model="header"></div>'+
//			'<div ng-show="separator" ><div class="label">Seperator</div><input type="text" ng-change="changeSeparator" ng-model="separator"></div>'+
			'<div><input class="btn btn-default btn-file" type="file"></div>',
